...
async function viewerLock() {
  ...
  if (packageJson.version !== "0.2.65" || installed?.version !== packageJson.version || !installed.integrity) {
    throw new Error("@docviewkit/viewer must be installed from the exact locked 0.2.65 package");
  }
